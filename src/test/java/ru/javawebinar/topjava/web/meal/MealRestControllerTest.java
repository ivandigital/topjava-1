...
class MealRestControllerTest extends AbstractControllerTest {
    ...
    @Test
    void getNotMine() throws Exception {
        RequestBuilder requestBuilder = MockMvcRequestBuilders.get(REST_URL + ADMIN_MEAL_ID)
                .with(userHttpBasic(USER));
        ...
        try {
            ...
            assertTrue(ex.getCause().getClass() == NotFoundException.class);
        }
    }
